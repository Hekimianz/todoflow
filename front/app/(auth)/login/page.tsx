...
export default function Login() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const { access_token } = await api.auth.login(form.username, form.password);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      {/* Orbs */}
      <div className="orb-1 absolute top-[-15%] left-[-10%] w-[500px] h-[500px] rounded-full bg-violet-700 opacity-30 blur-[100px] pointer-events-none" />
      <div className="orb-2 absolute bottom-[-15%] right-[-10%] w-[450px] h-[450px] rounded-full bg-purple-800 opacity-25 blur-[100px] pointer-events-none" />
      <div className="orb-3 absolute top-[40%] right-[20%] w-[200px] h-[200px] rounded-full bg-indigo-600 opacity-15 blur-[60px] pointer-events-none" />
